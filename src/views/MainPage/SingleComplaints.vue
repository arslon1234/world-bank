<template>
  <div class="singleComplaints">
    <router-link to="/complaints" class="back">
    ...
    <div class="items">
      ...
      <div class="items">
        <div class="item" v-for="item in complaintData" :key="item.id">
          <div class="left">
      ...
      >
        <div class="text">
          <p class="essence">
            <span class="essence">Рабочий орган</span>
            -
      ...
      <div class="actions" v-show="singleComplaints.status === 1">
        <button
  ...
  <app-modal v-model="accept_dialog" :width="'85%'">
    ...
    <!-- <AcceptComplaint
      :for_check="forms.for_check"
      :is_online="forms.is_online"
      :meeting_address="forms.meeting_address"
      :meeting_time="forms.meeting_time"
      :meeting_date="forms.meeting_date"
      :comment="forms.comment"
      :Open_next_dialog="Open_next_dialog"
      :accept_dialog="accept_dialog"
      :AcceptComplaint="AcceptComplaints($event)"
    ></AcceptComplaint> -->
  </app-modal>
...
const SaveReject = (event) => {
  event.preventDefault();
  http
    .post(`/complaints/reject-minfin/${url[4]}`, {
